...
# AWS IAM Policies
# #########################################
variable "iam_policy_container_registry_full_access" {
  type        = string
...
variable "iam_policy_lambda_execution_role" {
  type        = string
  description = "Provides write permissions to CloudWatch Logs."
  default     = "arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole"
}
variable "iam_policy_lambda_vpc_access_execution_role" {
  type        = string
...
variable "iam_policy_rds_enanched_monitoring" {
  type        = string
